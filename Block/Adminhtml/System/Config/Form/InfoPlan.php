...
abstract class InfoPlan extends \Magefan\Community\Block\Adminhtml\System\Config\Form\Info
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if ($text = $this->getText()) {
            ...
            $textHtml .= $text . ' <a style="color: #ef672f; text-decoration: underline;" href="https://magefan.com/magento-2-google-page-speed-optimizer/pricing?utm_source=admin&utm_medium=config&utm_campaign=upgrade-link" target="_blank">Read more</a>.';
            $textHtml .= '</div>';
        }
                                ...
                                $(this).click(function(){
                                    ...
                                    alert({
                                        ...
                                        buttons: [{
                                            ...
                                            click: function () {
                                                window.open("https://magefan.com/magento-2-google-page-speed-optimizer/pricing?utm_source=admin&utm_medium=config&utm_campaign=upgrade-popup");
                                            }
                                        }]
                                    });
                                }).on("focus", function() {
